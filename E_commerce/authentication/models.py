...
from django.utils.translation import deactivate, ugettext_lazy
...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    is_staff = models.BooleanField(
        ...
        default=False,
        help_text = ugettext_lazy('Designates whether the use can log in this site')
    )
    is_active=models.BooleanField(
        ugettext_lazy('active'),
        default=True,
        help_text=ugettext_lazy('Designates whether this user shold be treated as active. Unselect this instead of deleting accounts')
